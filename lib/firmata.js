...
Board.prototype.spiTransfer = function(options, callback) {
  ...
  if (typeof options === "object" && options !== null) {
    ...
    transferOptions = options.transferOptions || this.SPI_TRANSFER_OPTIONS.READ_WRITE;
  }
  ...
  if (transferOptions === this.SPI_TRANSFER_OPTIONS.READ_ONLY && numBytes === "undefined") {
    throw new Error("Must specify numBytes when using spiTransfer in read-only mode.");
  }

  if (pinOptions > 0 && typeof this.spiCsPins[channel] === "undefined") {
...
Board.prototype.spiWrite = function(inBytes, pinOptions) {
  ...
  this.spiTransfer({
    ...
    transferOptions: this.SPI_TRANSFER_OPTIONS.WRITE_ONLY
  });
};
...
Board.prototype.spiRead = function(numBytesToRead, pinOptions, callback) {
  ...
  this.spiTransfer({
    ...
    pinOptions: pinOptions,
    transferOptions: this.SPI_TRANSFER_OPTIONS.READ_ONLY
  }, callback);
};
...
Board.prototype.spiReadWrite = function(inBytes, pinOptions, callback) {
  ...
  this.spiTransfer({
    ...
    numBytes: inBytes.length,
    pinOptions: pinOptions,
    transferOptions: this.SPI_TRANSFER_OPTIONS.READ_WRITE
  }, callback);
};
